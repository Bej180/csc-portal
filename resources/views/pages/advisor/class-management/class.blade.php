...
<x-template nav="class" ng-controller="AdvisorClassController">
                                ...
                                <div class="panel-header">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        ...
                                        <div class="mr-2 label avatar avatar-lg">
                                            ...
                                            <span class="p-avatar-text">{{ $class->start_year }}</span>

                                        </div>
                                        <div>
                                            <span class="font-bold md:text-lg">CSC {{ $class->name }}</span>
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div ng-if="invitationLink" class="">
                            ...
                            <div class="input">
                                ...
                                <div class="flex justify-between gap-1 mt-2">
                                    ...
                                    <a class="link" ng-click="withdrawInviteLink()"><i class="fas fa-cut"></i>
                                        Withdraw</a>
                                    <a class="link" ng-click="generateInviteLink('Regenerated Invitation Link')"><i
                                            class="fa fa-undo"></i> Regenerate</a>
                                </div>
                    ...
                    <div class="font-bold text-2xl flex justify-between">
                        <div>
                            Students <span class="text-primary">{{ $students->count() }}</span>
                        </div>
                        <div>
                    ...
                    <div class="student-list" ng-show="!typing && !query">
                        @foreach ($students as $student)
                            <div student_id="{{ $student->id }}" ng-click="displayStudent({{ $student->id }})"
                                class="student">
