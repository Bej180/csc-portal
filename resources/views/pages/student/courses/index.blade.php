<div ng-if="reg_courses.length > 0" class="p-4">
    <div id="course-registration-container" class="flex flex-col gap-2 overflow-y-visible">
        ...
        <form ng-action="registerCourses()" method="POST">
            @csrf
            ...
            <div class="card has-table">
                <table class="responsive-table min-w-full whitespace-nowrap">
                    ...
                    <tbody id="course-registeration-prepend">
                        <tr ng-repeat="course in reg_courses" ng-controller="CourseController">
                            ...
                            <td class="uppercase pr-3 text-center">
                                {% course.option %}
                            </td>
                        </tr>
            ...
            <div class="flex justify-end my-2">
                <button ng-disabled="!proceed && (selectedUnits < minUnits || selectedUnits > maxUnits)" type="button" ng-submit
